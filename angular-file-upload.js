            ...
            .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
                function(fileUploaderOptions, $rootScope, $http, $window, $compile) {
                    ...
                    FileUploader.prototype.clearQueue = function() {
                        ...
                        this._onAfterRemovingAll(this.queue);
                        this.progress = 0;
                    };
                    /**
                     ...
                     * @param {FileItem} fileItem
                     */
                    FileUploader.prototype.onAfterRemovingFile = function(fileItem) {
                    };
                    ...
                    FileUploader.prototype._getFileOrFileLikeObject = function(some) {
                        if (this.isFile(some) || this.isFileLikeObject(some))
                            return some;
                     ...
                     * @param {FileItem} item
                     */
                    FileUploader.prototype._onAfterRemovingFile = function(item) {
                     ...
                     * @param {Array<FileItem>} items
                     */
                    FileUploader.prototype._onAfterRemovingAll = function(items) {
                        this.onAfterRemovingAll(items);
                    };
                    /**
                     *  Inner callback
                     * @param {FileItem} item
